...
/// Widget
class PatientDataForm extends ConsumerWidget with AddCaseFormMixin, AppMixins {
            ...
            return Column(
              ...
              children: [
                Row(
                  ...
                  children: [
                    children[0],
                    if (childrensCount > 1) const HorizontalSpacer.normal(),
                    children[1],
                  ],
                ),
                if (children.length > 2) const VerticalSpacer.normal(),
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    children[2],
                    if (childrensCount > 3) const HorizontalSpacer.normal(),
                    children[3],
                  ],
                ),
              ],
