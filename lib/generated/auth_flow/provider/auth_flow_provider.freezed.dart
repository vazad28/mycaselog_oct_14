...
part of '../../../auth_flow/provider/auth_flow_provider.dart';
...
mixin _$AuthFlowState {
  ...
  TResult map<TResult extends Object?>({
    required TResult Function(_Unboarded value) unboarded,
...
class _$UnboardedImpl extends _Unboarded {
  const _$UnboardedImpl() : super._();

  @override
  String toString() {
    return 'AuthFlowState.unboarded()';
  }
  ...
  TResult map<TResult extends Object?>({
    ...
    return unboarded(this);
  }
}

abstract class _Unboarded extends AuthFlowState {
  const factory _Unboarded() = _$UnboardedImpl;
  const _Unboarded._() : super._();
}
...
abstract class _Unauthenticated extends AuthFlowState {
