...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/cupertino_activity_indicator.gif
  AssetGenImage get cupertinoActivityIndicator =>
      const AssetGenImage('assets/images/cupertino_activity_indicator.gif');

  /// File path: assets/images/missing_image.png
  AssetGenImage get missingImage =>
      const AssetGenImage('assets/images/missing_image.png');

  /// File path: assets/images/placeholder-image-icon.png
  AssetGenImage get placeholderImageIcon =>
      const AssetGenImage('assets/images/placeholder-image-icon.png');
...
class $AssetsLogoGen {
  ...
  /// File path: assets/logo/app_logo_icon.png
  AssetGenImage get appLogoIcon =>
      const AssetGenImage('assets/logo/app_logo_icon.png');

  /// List of all assets
  List<AssetGenImage> get values => [appLogo, appLogoIcon];
}

class $AssetsOnboardingGen {
  const $AssetsOnboardingGen();

  /// File path: assets/onboarding/bar-chart.svg
  SvgGenImage get barChart =>
      const SvgGenImage('assets/onboarding/bar-chart.svg');

  /// File path: assets/onboarding/photos.svg
  SvgGenImage get photos => const SvgGenImage('assets/onboarding/photos.svg');

  /// File path: assets/onboarding/records.svg
  SvgGenImage get records => const SvgGenImage('assets/onboarding/records.svg');

  /// File path: assets/onboarding/surgeon.svg
  SvgGenImage get surgeon => const SvgGenImage('assets/onboarding/surgeon.svg');

  /// File path: assets/onboarding/take-photos.svg
  SvgGenImage get takePhotos =>
      const SvgGenImage('assets/onboarding/take-photos.svg');

  /// List of all assets
  List<SvgGenImage> get values =>
      [barChart, photos, records, surgeon, takePhotos];
}
