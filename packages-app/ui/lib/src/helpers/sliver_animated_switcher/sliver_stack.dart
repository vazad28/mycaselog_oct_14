...
import 'rendering_sliver_stack.dart';
...
class SliverStack extends MultiChildRenderObjectWidget {
  ...
  SliverStack({
    required super.children, super.key,
    this.textDirection,
...
class SliverPositioned extends ParentDataWidget<SliverStackParentData> {
  ...
  SliverPositioned.fromRect({
    required Rect rect, required super.child, super.key,
  })  : left = rect.left,
        top = rect.top,
        width = rect.width,
        height = rect.height,
  ...
  SliverPositioned.fromRelativeRect({
    required RelativeRect rect, required super.child, super.key,
  })  : left = rect.left,
        top = rect.top,
        right = rect.right,
        bottom = rect.bottom,
  ...
  factory SliverPositioned.directional({
    required TextDirection textDirection, required Widget child, Key? key,
    double? start,
    double? top,
    double? end,
    double? bottom,
